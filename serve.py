...
index.write("""<head>
  ...
  <div class="wrap">
    ...
    <a class="site-title" href="./index.html">Vincent Knight: Talks</a>
    ...
    <nav class="site-nav">
      ...
      <div class="trigger">
          ...
          <a class="page-link" href="https://github.com/drvinceknight/Talks">Github</a>
          <a class="page-link" href="http://www.vincent-knight.com/">Personal webpage</a>
      </div>
    </nav>
...
index.write("""</ul>
  ...
  <div class="wrap">
    ...
    <h2 class="footer-heading">Un peu de math</h2>
    ...
    <div class="footer-col-2 column">
      <p class="text">This site contains my talks. It is automatically generated from <a href='https://github.com/drvinceknight/Talks' target='_blank'>this github repository</a>.</p>
    </div>
