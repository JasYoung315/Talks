...
A =
\begin{pmatrix}
U_{\NH}(1,1)-t&\dots&U_{\NH}(1,c_{\RG})-t\\
U_{\NH}(2,1)-t&\dots&U_{\NH}(2,c_{\RG})-t\\
\vdots&\ddots&\vdots\\
U_{\NH}(c_{\NH},1)-t&\dots&U_{\NH}(c_{\NH},c_{\RG})-t\\
\end{pmatrix}
$$
\vspace{1cm}
$$
B =
\begin{pmatrix}
U_{\RG}(1,1)-t&\dots&U_{\RG}(1,c_{\RG})-t\\
U_{\RG}(2,1)-t&\dots&U_{\RG}(2,c_{\RG})-t\\
\vdots&\ddots&\vdots\\
U_{\RG}(c_{\RG},1)-t&\dots&U_{\RG}(c_{\RG},c_{\RG})-t\\
\end{pmatrix}
$$
}
...
\href{}{+Vincent.Knight}\\
\href{}{@drvinceknight}\\
\framebox{\url{drvinceknight.github.io/Talks}}\\
\vspace{1cm}
\href{}{@IzabelaKomenda}\\
Professor Jeff Griffiths
\end{center}
